...
def dummy_raw_db(tmp_path):
    ...
    features_data = {
        ...
        "event_timestamp": ["2023-01-02", "2023-01-02", "2023-01-03", "2023-01-03", "2023-01-04"],
...
def test_run_profiling(dummy_raw_db, tmp_path):
    ...
    src.profile_data.generate_data_dictionary = lambda: original_generate(docs_dir=str(tmp_path / "docs"))
